...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.mDay.setText(dateString);
        forecastAdapterViewHolder.mDescription.setText(description);
        forecastAdapterViewHolder.mMaxTemp.setText(SunshineWeatherUtils.formatTemperature(mContext, highInCelsius));
        forecastAdapterViewHolder.mMinTemp.setText(SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius));

        int weatherImageId = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        forecastAdapterViewHolder.mWeatherIcon.setImageResource(weatherImageId);
    }
...
//          COMPLETED (6) Get references to all new views and delete this line
            mDay = (TextView) view.findViewById(R.id.textViewDay);
            mDescription = (TextView) view.findViewById(R.id.textViewWeatherDescription);
            mMinTemp = (TextView) view.findViewById(R.id.textViewMinTemp);
            mMaxTemp = (TextView) view.findViewById(R.id.textViewMaxTemp);
            mWeatherIcon = (ImageView) view.findViewById(R.id.imageViewWeatherIcon);
