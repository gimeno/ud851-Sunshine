...
//      COMPLETED (21) Implement LoaderManager.LoaderCallbacks<Cursor>
    ...
    public static final String[] DETAILED_FORECAST_PROJECTION = new String[]{
...
//  COMPLETED (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    private TextView mDateDisplay, mDescriptionDisplay, mHighTempDisplay, mLowTempDisplay,
        mHumidityDisplay, mWindDisplay, mPressureDisplay;
...
//      COMPLETED (13) Find each of the TextViews by ID
        mDateDisplay = (TextView) findViewById(R.id.tv_selected_day_date);
        mDescriptionDisplay = (TextView) findViewById(R.id.tv_selected_day_description);
        mHighTempDisplay = (TextView) findViewById(R.id.tv_selected_day_max_temp);
        mLowTempDisplay = (TextView) findViewById(R.id.tv_selected_day_min_temp);
        mHumidityDisplay = (TextView) findViewById(R.id.tv_selected_day_humidity);
        mWindDisplay = (TextView) findViewById(R.id.tv_selected_day_wind);
        mPressureDisplay = (TextView) findViewById(R.id.tv_selected_day_pressure);
...
//      COMPLETED (35) Initialize the loader for DetailActivity
        getSupportLoaderManager().initLoader(ID_DETAILED_FORECAST_LOADER, null, this);
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        switch (id) {
            case ID_DETAILED_FORECAST_LOADER:

                return new CursorLoader(this,
                        mUri,
                        DETAILED_FORECAST_PROJECTION,
                        null,
                        null,
                        null);
            default:
